...
inline std::unordered_map<std::string, InstructionFormat> opcode_table = {
    ...
    // I type instructions
    {"lb", {0b0000011, 0b000, 0b1111111, "I"}},
    {"lh", {0b0000011, 0b001, 0b1111111, "I"}},
    {"lw", {0b0000011, 0b010, 0b1111111, "I"}},
    {"ld", {0b0000011, 0b011, 0b1111111, "I"}},
    {"lbu", {0b0000011, 0b100, 0b1111111, "I"}},
    {"lhu", {0b0000011, 0b101, 0b1111111, "I"}},
    {"lwu", {0b0000011, 0b110, 0b1111111, "I"}},
    {"fence", {0b0001111, 0b000, 0b1111111, "I"}},
    {"fence.i", {0b0001111, 0b001, 0b1111111, "I"}},
    {"addi", {0b0010011, 0b000, 0b1111111, "I"}},
    {"slli", {0b0010011, 0b001, 0b0000000, "I"}},
    {"slti", {0b0010011, 0b010, 0b1111111, "I"}},
    {"sltiu", {0b0010011, 0b011, 0b1111111, "I"}},
    {"xori", {0b0010011, 0b100, 0b1111111, "I"}},
    {"srli", {0b0010011, 0b101, 0b0000000, "I"}},
    {"srai", {0b0010011, 0b101, 0b0100000, "I"}},
    {"ori", {0b0010011, 0b110, 0b1111111, "I"}},
    {"andi", {0b0010011, 0b111, 0b1111111, "I"}},
    {"addiw", {0b0011011, 0b000, 0b1111111, "I"}},
    {"slliw", {0b0011011, 0b001, 0b0000000, "I"}},
    {"srliw", {0b0011011, 0b101, 0b0000000, "I"}},
    {"sraiw", {0b0011011, 0b111, 0b0100000, "I"}},
    {"jalr", {0b1100111, 0b000, 0b1111111, "I"}},
    {"ecall", {0b1110011, 0b000, 0b0000000, "I"}},
    {"ebreak", {0b0010011, 0b000, 0b0100000, "I"}},
    {"CSRRW", {0b0010011, 0b001, 0b1111111, "I"}},
    {"CSRRS", {0b0010011, 0b010, 0b1111111, "I"}},
    {"CSRRC", {0b0010011, 0b011, 0b1111111, "I"}},
    {"CSRRWI", {0b0010011, 0b101, 0b1111111, "I"}},
    {"CSRRSI", {0b0010011, 0b110, 0b1111111, "I"}},
    {"CSRRCI", {0b0010011, 0b111, 0b1111111, "I"}},

    // S type instructions
    {"sb", {0b0100011, 000, 0b1111111, "S"}},
    {"sh", {0b0100011, 001, 0b1111111, "S"}},
    {"sw", {0b0100011, 010, 0b1111111, "S"}},
    {"sd", {0b0100011, 011, 0b1111111, "S"}},

    // B type instructions
    {"beq", {0b1100011, 0b000, 0b1111111, "B"}},
    {"bne", {0b1100011, 0b001, 0b1111111, "B"}},
    {"blt", {0b1100011, 0b100, 0b1111111, "B"}},
    {"bge", {0b1100011, 0b101, 0b1111111, "B"}},
    {"bltu", {0b1100011, 0b110, 0b1111111, "B"}},
    {"bgeu", {0b1100011, 0b111, 0b1111111, "B"}},
